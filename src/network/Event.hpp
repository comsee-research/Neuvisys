...
public:
    Event() = default;
    inline Event(uint64_t timestamp, uint16_t x, uint16_t y, bool polarity) : m_timestamp(timestamp), m_x(x), m_y(y), m_polarity(polarity), m_camera(0) { m_synapse = 0; }
    inline Event(uint64_t timestamp, uint16_t x, uint16_t y, bool polarity, uint16_t camera) : m_timestamp(timestamp), m_x(x), m_y(y), m_polarity(polarity), m_camera(camera) { m_synapse = 0; }
    inline Event(uint64_t timestamp, uint16_t x, uint16_t y, bool polarity, uint16_t camera, uint16_t synapse) : m_timestamp(timestamp), m_x(x), m_y(y), m_polarity(polarity), m_camera(camera), m_synapse(synapse) {}
