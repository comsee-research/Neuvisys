...
public:
    ...
    QFormLayout *formLayoutSimulationStatistics;
    QLabel *label_on_off_ratio;
    QLCDNumber *lcd_on_off_ratio;
    QLCDNumber *lcd_event_rate;
    QLabel *label_event_rate;
    QGroupBox *network_stats;
    ...
    void setupUi(QMainWindow *NeuvisysGUI)
    {
        ...
        sizePolicy.setHeightForWidth(tab_selection->sizePolicy().hasHeightForWidth());
        tab_selection->setSizePolicy(sizePolicy);
        ...
        sizePolicy1.setHeightForWidth(launch_options->sizePolicy().hasHeightForWidth());
        launch_options->setSizePolicy(sizePolicy1);
        ...
        scrollAreaWidgetContentsNeuronSelection->setGeometry(QRect(0, 0, 96, 26));
        ...
        formLayoutSimulationStatistics = new QFormLayout();
        formLayoutSimulationStatistics->setObjectName(QString::fromUtf8("formLayoutSimulationStatistics"));
        label_on_off_ratio = new QLabel(groupBox);
        label_on_off_ratio->setObjectName(QString::fromUtf8("label_on_off_ratio"));

        formLayoutSimulationStatistics->setWidget(1, QFormLayout::LabelRole, label_on_off_ratio);

        lcd_on_off_ratio = new QLCDNumber(groupBox);
        lcd_on_off_ratio->setObjectName(QString::fromUtf8("lcd_on_off_ratio"));
        lcd_on_off_ratio->setMinimumSize(QSize(0, 40));
        lcd_on_off_ratio->setMaximumSize(QSize(200, 100));
        lcd_on_off_ratio->setDigitCount(8);

        formLayoutSimulationStatistics->setWidget(1, QFormLayout::FieldRole, lcd_on_off_ratio);

        lcd_event_rate = new QLCDNumber(groupBox);
        lcd_event_rate->setObjectName(QString::fromUtf8("lcd_event_rate"));
        lcd_event_rate->setMinimumSize(QSize(0, 40));
        lcd_event_rate->setMaximumSize(QSize(200, 100));
        lcd_event_rate->setDigitCount(8);

        formLayoutSimulationStatistics->setWidget(0, QFormLayout::FieldRole, lcd_event_rate);

        label_event_rate = new QLabel(groupBox);
        label_event_rate->setObjectName(QString::fromUtf8("label_event_rate"));

        formLayoutSimulationStatistics->setWidget(0, QFormLayout::LabelRole, label_event_rate);


        gridLayout_4->addLayout(formLayoutSimulationStatistics, 0, 0, 1, 1);


        gridLayout_3->addWidget(groupBox, 0, 0, 1, 1);

        network_stats = new QGroupBox(statistics);
        network_stats->setObjectName(QString::fromUtf8("network_stats"));
        QSizePolicy sizePolicy3(QSizePolicy::MinimumExpanding, QSizePolicy::MinimumExpanding);
        sizePolicy3.setHorizontalStretch(0);
        sizePolicy3.setVerticalStretch(0);
        sizePolicy3.setHeightForWidth(network_stats->sizePolicy().hasHeightForWidth());
        network_stats->setSizePolicy(sizePolicy3);
        gridLayout_5 = new QGridLayout(network_stats);
        gridLayout_5->setObjectName(QString::fromUtf8("gridLayout_5"));
        formLayout_2 = new QFormLayout();
        formLayout_2->setObjectName(QString::fromUtf8("formLayout_2"));
        bias = new QLabel(network_stats);
        bias->setObjectName(QString::fromUtf8("bias"));

        formLayout_2->setWidget(0, QFormLayout::LabelRole, bias);

        lcd_bias = new QLCDNumber(network_stats);
        lcd_bias->setObjectName(QString::fromUtf8("lcd_bias"));
        lcd_bias->setMinimumSize(QSize(0, 40));
        lcd_bias->setMaximumSize(QSize(200, 100));
        lcd_bias->setDigitCount(8);

        formLayout_2->setWidget(0, QFormLayout::FieldRole, lcd_bias);

        spike_rate = new QLabel(network_stats);
        spike_rate->setObjectName(QString::fromUtf8("spike_rate"));

        formLayout_2->setWidget(1, QFormLayout::LabelRole, spike_rate);

        lcd_spike_rate = new QLCDNumber(network_stats);
        ...
        lcd_spike_rate->setDigitCount(8);

        formLayout_2->setWidget(1, QFormLayout::FieldRole, lcd_spike_rate);

        threshold = new QLabel(network_stats);
        threshold->setObjectName(QString::fromUtf8("threshold"));

        formLayout_2->setWidget(2, QFormLayout::LabelRole, threshold);

        lcd_threshold = new QLCDNumber(network_stats);
        ...
        lcd_threshold->setDigitCount(8);

        formLayout_2->setWidget(2, QFormLayout::FieldRole, lcd_threshold);


        gridLayout_5->addLayout(formLayout_2, 0, 0, 1, 1);


        gridLayout_3->addWidget(network_stats, 1, 0, 1, 1);
        ...
        sizePolicy4.setHeightForWidth(lcd_sim_time->sizePolicy().hasHeightForWidth());
        lcd_sim_time->setSizePolicy(sizePolicy4);
    ...
    void retranslateUi(QMainWindow *NeuvisysGUI)
    {
        ...
        groupBox->setTitle(QApplication::translate("NeuvisysGUI", "Simulation statistics", nullptr));
        label_on_off_ratio->setText(QApplication::translate("NeuvisysGUI", "ON/OFF ratio", nullptr));
        label_event_rate->setText(QApplication::translate("NeuvisysGUI", "Event rate (event/s)", nullptr));
        network_stats->setTitle(QApplication::translate("NeuvisysGUI", "Network statistics", nullptr));
        bias->setText(QApplication::translate("NeuvisysGUI", "Bias", nullptr));
        spike_rate->setText(QApplication::translate("NeuvisysGUI", "Spike rate (spike/s):", nullptr));
        threshold->setText(QApplication::translate("NeuvisysGUI", "Threshold (mV):", nullptr));
